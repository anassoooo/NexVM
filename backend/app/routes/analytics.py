...
from app.dependencies import UserClaims, get_current_admin_user, get_current_user
...
def get_user_analytics(
    ...
    return analytics_service.get_user_analytics(claims.id)


@router.get("/admin", response_model=AdminAnalytics)
def get_admin_analytics(
    _: Annotated[UserClaims, Depends(get_current_admin_user)],
) -> AdminAnalytics:
...
def get_user_timeseries(
    ...
    return analytics_service.get_user_timeseries(claims.id, days)
